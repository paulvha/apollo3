...
#define BLE_PERIPHERAL_NAME "Artemis Button" // Up to 29 characters

void setup() {

  SERIAL_PORT.begin(115200);
  delay(1000);
  SERIAL_PORT.printf("Apollo3 Arduino Button BLE Example. Compiled: %s\n", __TIME__);
...
//// SPECIAL_BUTTON ADDED BUTTON functions START

#define UpButton 0x11
#define DownButton 0x12
#define ActButton 0x13
#define OffButton 0x14

void button_received(uint8_t b)
{
  SERIAL_PORT.printf("received value : ox%X, ", b);
  
  switch(b) {
    case UpButton:
      SERIAL_PORT.printf("UpButton received\n");
      break;
    case DownButton:
      SERIAL_PORT.printf("DownButton received\n");
      break;          
    case ActButton:
      SERIAL_PORT.printf("ActButton received\n");
      break;
    case OffButton:
      SERIAL_PORT.printf("OffButton received\n");
      break;
    default:
      SERIAL_PORT.printf("No idea what this is\n");
    
  }
}

//// SPECIAL_BUTTON ADDED BUTTON functions END

 ...
 * author  : paulvha
 * 
 * This example is only tested V1.2.3 of the Sparkfun Apollo3 Library
 * It requires the special verion of the ap3_analog.cpp and ap3_analog.h
 * 
...
void setup() {
    ...
    Serial.begin(115200);
        Serial.println("Example3_V1 : Fast Analog Read Speed Test");
    
    // make sure pins have already been set for input    

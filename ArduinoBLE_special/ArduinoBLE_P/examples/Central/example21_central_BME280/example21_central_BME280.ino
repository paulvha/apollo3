/*
  ...
  It is mend to show how the example21_ph_BME280 peripheral could be accessed and how
...
*********************************************************************
  ...
  On Sparkfun library V12.3. the ExactLE package needs to be installed
...
*********************************************************************
  ...
  Make sure to load on another Apollo3 board the peripheral: example21_ph_BME280
...
* Versioning
*********************************************************************
  Version 2.1 / January 2022 / paulvha
  - based on Version 2.0 example20 central, now added to set to sleep
  - initial version
*/
...
void setup() {
  ...
  while(! SERIAL_PORT);
  SERIAL_PORT.println(F("Example21: Arduino Central BME280.\r"));
...
void display_menu()
{
  ...
  SERIAL_PORT.println(F("9.  Disconnect from peripheral\r"));
}

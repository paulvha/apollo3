/*
  ...
  It is mend to show how the example20_ph_BME280 peripheral could be accessed and how
...
*********************************************************************
  ...
  Make sure to load on another board the example20_ph_BME280 sketch.

  Start the peripheral: example20_ph_BME280
...
void setup() {
  ...
  while(! SERIAL_PORT);
  SERIAL_PORT.println(F("Example20: Arduino Central BME280.\r"));

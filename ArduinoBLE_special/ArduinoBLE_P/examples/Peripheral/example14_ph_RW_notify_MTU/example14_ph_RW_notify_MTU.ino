...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! 
  ...
  in blocksizes that are based on the agreed MTU size. 
  So we will create blocks of max. MTU bytes that include checks to have a reliable exchange. 
  Once a block is ready to be read, a notification will be send to the central. The central will read and check for 
  correct block / CRC and provide feedback on success and request the next block. 
...
// BLE defines
///////////////////////////////////////////////////////
const char BLE_PERIPHERAL_NAME[] = "Example14 BLE";

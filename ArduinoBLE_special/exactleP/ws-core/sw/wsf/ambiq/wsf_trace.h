...
/*! \brief      added paulvha for tracing*/
typedef void (*WsfTraceHandler_t)(const uint8_t *pBuf, uint32_t len);
...
#define WSF_TRACE_FREE2(msg, var1, var2)            WSF_TRACE2("WSF", "free",  msg, var1, var2)

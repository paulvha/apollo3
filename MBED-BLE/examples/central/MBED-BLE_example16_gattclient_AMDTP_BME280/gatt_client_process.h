 ...
 * Call a function after ble.init or connection has completed
...
public:
 ...
 /**
   ...
   */
  bool SendToServer(uint8_t *sdata, uint16_t slen)
  {
    return (_CL_AMDTP.SendToServer(sdata,slen));
  }

  // return true if all chunks of data has been send
  ...
  // true if discovery and service are ready
